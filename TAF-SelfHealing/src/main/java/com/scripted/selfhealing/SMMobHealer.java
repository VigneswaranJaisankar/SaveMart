...
public class SMMobHealer {
	...
	MobileElement locator_resource_id = null;
	MobileElement locator_xpath_text = null;
	MobileElement locator_xpath_index = null;
	MobileElement locator_xpath_content_desc =null;
	MobileElement locator_xpath_position =null;
...
//						System.out.println("Sel attribute :" + attrTyp + ":" + attrVle);
	...
	private String captureScreenScrnshot(MobileDriver driver, MobileElement eleScreenCapture) {
		StringBuffer scrFileNme = new StringBuffer();
		try {
			DateFormat dateFormat = new SimpleDateFormat("dd_MM_yyyy_hh_mm_ss_ms_aa");
			String dateString = dateFormat.format(new Date()).toString();
	...
	public ElementValue verifyMobileElement(ConcurrentHashMap<String, String> attributeMap, MobileDriver ldriver) {
			...
			keysmob.parallelStream().forEach((key1) -> {
				try {
					if (!key1.equals(locatorType)) {
						...
						switch (key1) {
						case "resource-id":
							locator_resource_id = (MobileElement) ldriver.findElement(By.id(attributeMap.get("resource-id")));
							// System.out.println("id Locator value in verify element : " + locator_id);
						...
						case "xpath_index":
							if (!(locatorType.equals("id") && attributeMap.get("xpath_index").contains("id"))) {
								...
								// System.out.println("checking using xpath_Follows : " +
								// attributeMap.get("xpath_Follows"));
								locator_xpath_index = (MobileElement) ldriver
						...
						case "xpath_content-desc":
							if (!(locatorType.equals("id") && attributeMap.get("xpath_content-desc").contains("id"))) {
								...
								// System.out.println("checking using xpath_default: " +
								// attributeMap.get("xpath_default"));
								locator_xpath_content_desc = (MobileElement) ldriver
						...
						case "xpath_text":
							if (!(locatorType.equals("id") && attributeMap.get("xpath_text").contains("id"))) {
								...
								// System.out.println("checking using xpath_Parent " +
								// attributeMap.get("xpath_Parent"));
								locator_xpath_text = (MobileElement) ldriver
						...
						case "class":
							...
							// System.out.println("checking using class : " +
							// attributeMap.get("classname"));
							locator_class = (MobileElement) ldriver.findElement(By.className(attributeMap.get("classname")));
							// System.out.println("verified by class" + attributeMap.get("classname"));
