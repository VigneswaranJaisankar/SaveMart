...
public class OfferDisplay_Foodmaxx {
	/*
	  WebDriver driver1;
	  ...
	  private WebElement FOODMAXXCOUPONS;
	  
	  @FindBy(xpath="//a[contains(@href,'/user_info/offers/available')]") 
	  private WebElement Available;
	  
	  
	  @FindBy(tagName="(//div[@class='offer-grid hide-mct-spinner']//img") 
	 ...
	 public void enterPassword(String password) {
	  ...
	  public void clickLuckyrewards() {
	  
	  WebHandlers.click(FOODMAXXCOUPONS);
	  ...
	  // increment as invalid images count 
	   if
	  (response.getStatusLine().getStatusCode() != 200) invalidImageCount++; }
	  catch (Exception e) { e.printStackTrace(); } }
	  ...
	  String name = names[names.length-1]; System.out.println(name); 
