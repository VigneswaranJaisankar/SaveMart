...
public class OfferPageFM_Android {
	
	
	public static Logger LOGGER = LogManager.getLogger(OfferPageFM_Android.class);
	...
	public OfferPageFM_Android(AppiumDriver<WebElement> appiumdriver) {
