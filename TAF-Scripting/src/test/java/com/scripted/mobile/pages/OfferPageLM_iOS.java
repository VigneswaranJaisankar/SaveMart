...
public class OfferPageLM_iOS {
	
	public static Logger LOGGER = LogManager.getLogger(OfferPageLM_iOS.class);
	...
	public OfferPageLM_iOS(IOSDriver<WebElement> IOSDriver) {
